...
/*   Updated: 2025/02/20 16:34:49 by fde-jesu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string Name) : name(Name), hit_pts(10), energy_pts(10), attack_dmg(0){std::cout  << "ClapTrap " << name << " constructor called!!" << std::endl;}
ClapTrap::ClapTrap(void) : name("robot"), hit_pts(10), energy_pts(10), attack_dmg(0){std::cout  << "ClapTrap " << name << " constructor called!!" << std::endl;}
